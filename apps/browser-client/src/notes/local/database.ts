...
export type Row = { id: string; title: string; body: string; revision: number; created_at: string | null; updated_at: string;
...
export const columns = 'id, title, body, tags, revision, created_at, updated_at, deleted_at, dirty, mutation_id, base_revision, synced_body, synced_title'
