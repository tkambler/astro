...
1. Finish and test the intended changes locally. If they include a database migration, back up the `astronote_postgres_data` volume before deploying.
